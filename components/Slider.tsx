...
const Slider = () => {
  ...
  return (
    <div className='flex flex-col  h-[calc(100vh-6rem)] md:h-[calc(100VH-9rem)] lg:flex-row bg-orange-100'>
      {/* TEXT CONTAINER */}
      <div className='flex-1 h-1/2 flex items-center justify-center flex-col gap-8 text-orange-500 font-bold lg:h-full lg:w-1/2'>
        <h1 className='text-5xl text-center uppercase p-4 md:p-10 md:text-6xl xl:text-7xl'>
            {data[currentSlide].title}
        </h1>
        <button className='bg-orange-500 text-white py-4 px-8 cursor-pointer'>Order Now</button>
      </div>
      {/* IMAGE CONTAINER */}
